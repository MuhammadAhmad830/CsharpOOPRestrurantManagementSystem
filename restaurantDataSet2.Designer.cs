...
namespace RestaurantManagementSystem {
    ...
    public partial class restaurantDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemsRow AddItemsRow(string Name, decimal Price, string CategoryName, int Stock, string Status) {
...
namespace RestaurantManagementSystem.restaurantDataSet2TableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Price] = @Original_Price) AND ([CategoryName] = @Original_CategoryName" +
                ") AND ([Stock] = @Original_Stock) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([Name], [Price], [CategoryName], [Stock], [Status]) VA" +
                "LUES (@Name, @Price, @CategoryName, @Stock, @Status);\r\nSELECT Id, Name, Price, C" +
                "ategoryName, Stock, Status FROM Items WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [Name] = @Name, [Price] = @Price, [CategoryName] = @CategoryName, [Stock] = @Stock, [Status] = @Status WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([CategoryName] = @Original_CategoryName) AND ([Stock] = @Original_Stock) AND ([Status] = @Original_Status));
SELECT Id, Name, Price, CategoryName, Stock, Status FROM Items WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, CategoryName, Stock, Status FROM dbo.Items";
        ...
        public virtual int Fill(restaurantDataSet2.ItemsDataTable dataTable) {
        ...
        public virtual restaurantDataSet2.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            restaurantDataSet2.ItemsDataTable dataTable = new restaurantDataSet2.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(restaurantDataSet2.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName, int Original_Stock, string Original_Status) {
        ...
        public virtual int Insert(string Name, decimal Price, string CategoryName, int Stock, string Status) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, decimal Price, string CategoryName, int Stock, string Status, int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName, int Original_Stock, string Original_Status, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, string CategoryName, int Stock, string Status, int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName, int Original_Stock, string Original_Status) {
            return this.Update(Name, Price, CategoryName, Stock, Status, Original_Id, Original_Name, Original_Price, Original_CategoryName, Original_Stock, Original_Status, Original_Id);
        }
    }
