...
namespace RestaurantManagementSystem {
    ...
    public partial class restaurantDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemsRow AddItemsRow(string Name, decimal Price, string CategoryName) {
...
namespace RestaurantManagementSystem.restaurantDataSet1TableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [Name] = @Name, [Price] = @Price, [CategoryName] = @CategoryName WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([CategoryName] = @Original_CategoryName));
SELECT Id, Name, Price, CategoryName FROM Items WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Price, CategoryName FROM dbo.Items";
        ...
        public virtual int Fill(restaurantDataSet1.ItemsDataTable dataTable) {
        ...
        public virtual restaurantDataSet1.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            restaurantDataSet1.ItemsDataTable dataTable = new restaurantDataSet1.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(restaurantDataSet1.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName) {
        ...
        public virtual int Update(string Name, decimal Price, string CategoryName, int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, string CategoryName, int Original_Id, string Original_Name, decimal Original_Price, string Original_CategoryName) {
            return this.Update(Name, Price, CategoryName, Original_Id, Original_Name, Original_Price, Original_CategoryName, Original_Id);
        }
    }
